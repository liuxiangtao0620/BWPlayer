#
#  Be sure to run `pod spec lint BWPlayer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/liuxiangtao0620/BWPlayer.git", :tag => "0.0.1" }
  ...
  s.source_files  = "BWPlayer", "BWPlayer/**/*.{h,m}"
